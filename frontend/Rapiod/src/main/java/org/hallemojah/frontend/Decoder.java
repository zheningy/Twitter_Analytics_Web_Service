...
public class Decoder{
    ...
    public static String enAndDe(String choice, String strInput){
        ...
        dOrE = choice;
//	if (localCache.containsKey(strInput)) return localCache.get(strInput);
        if (dOrE == "encode"){
            strr = strInput;
            int li = strr.length();
  ...
  //              System.out.println(matrix[i]);
   ...
   //                     System.out.println(i+" "+j);
            ...
            if (indexi[0] == indexi[1] && indexi[1]<indexi[2])
            {
                ...
                maxi = indexi[0]; maxj = indexj[0];
            }
            if (indexi[2] == indexi[1])
            {
                if(indexj[0] != indexj[1]) {pattern = 2;maxi = indexi[0]; maxj = indexj[1];}
                else {pattern = 3;maxi = indexi[0]; maxj = indexj[0];}
            }
/*            for (i = 0; i < size ; i++)
            {
                for (j = 0; j < size ; j++)
...
*/
            ...
            if (pattern == 0)
            {
                for (i = 0; i < size ; i++)
                {
                    for (j = 0; j < size ; j++)
                    {
                        newmatrix[i][j] = matrix[i+maxi][j+maxj];
                    }
                }
            }
            if (pattern == 1)
            {
                for (i = 0; i < size ; i++)
                {
                    for (j = 0; j < size ; j++)
                    {
                        newmatrix[size - j-1][i] = matrix[i+maxi][j+maxj];
                    }
                }
            }
            if (pattern == 2)
            {
                for (i = 0; i < size ; i++)
                {
                    for (j = 0; j < size ; j++)
                    {
                        newmatrix[size - i-1][size - j-1] = matrix[i+maxi][j+maxj];
                    }
                }
            }
            if (pattern == 3)
            {
                for (i = 0; i < size ; i++)
                {
                    for (j = 0; j < size ; j++)
                    {
                        newmatrix[j][size - i-1] = matrix[i+maxi][j+maxj];
                    }
                }
            }
/*
...
*/
                    ...
                    if (j % 2 == 0)
                    {
                        for (i = 20; i>=8; i--)
                        {
                            ...
                            if (indexw == 8)
                            {
                                ...
                                if (count%2 == 0) output+=(char) getSum(word);
  ...
  //      localCache.put(strInput, output);
        return output;
